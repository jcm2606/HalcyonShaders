...
*/
  ...
  #define ATMOS_LIGHTING_SKY_INTENSITY 16.0

  #define SUN_LIGHT_INTENSITY 32768.0
  #define SUN_SPOT_MULTIPLIER 0.25

  #define MOON_LIGHT_INTENSITY 1.0
  #define MOON_SPOT_MULTIPLIER 1.0

  // BLOCK LIGHTMAP
  #define BLOCK_LIGHT_ANISOTROPY 0.46 // [0.0 0.4 0.41 0.42 0.43 0.44 0.45 0.46 0.47 0.48 0.49 0.5]
