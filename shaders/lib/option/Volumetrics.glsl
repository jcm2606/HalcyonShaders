...
*/
  ...
  #define FOG_LAYER_HEIGHT_DENSITY 0.2 // How dense should height fog be?. [0.05]
  ...
  #define FOG_LAYER_SHEET_DENSITY 32.0 // How dense should height fog be?. [32.0]
  #define FOG_LAYER_SHEET_FALLOFF 1.0 // How quick should height fog get thinner, relative to world height?. The higher this value is, the quicker the fog gets thinner. [1.0]
  #define FOG_LAYER_SHEET_OCTAVES 3
