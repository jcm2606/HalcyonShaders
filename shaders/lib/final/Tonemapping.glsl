...
*/
...
#ifndef INTERNAL_INCLUDED_FINAL_TONEMAPPING
  #define INTERNAL_INCLUDED_FINAL_TONEMAPPING
  ...
  vec3 tonemap(in vec3 colour) {
    colour = saturation(colour, actualSaturation);

    return Tonemap(colour);
  }

#endif /* INTERNAL_INCLUDED_FINAL_TONEMAPPING */